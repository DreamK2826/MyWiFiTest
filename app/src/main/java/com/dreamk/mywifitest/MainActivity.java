...
public class MainActivity extends AppCompatActivity {
    ...
    void findViews() {
        ...
        btn_startS1 = findViewById(R.id.btn_startS1);
        btn_finish = findViewById(R.id.btn_finish);
        btn_zc1 = findViewById(R.id.btn_zc1);
...
//                deInitEasySocket();
                ...
                if (flagScaned1) {
                    ...
                    if (!name.isEmpty() && !pos1.isEmpty() && !pos2.isEmpty()) {
                        ...
                        for (int i = 0; i < apData.size(); i++) {
                            if (i < apData.size() - 1) {
                                sb.append(apData.get(i)).append("\0");
                            } else {
                                sb.append(apData.get(i)).append("\0\r\n#END#$");
                            }
                        }
                    ...
                    ToastUtil.show(this, "请等待下次扫描后发送！");
                }
            } else {
        ...
        btn_startS1.setOnClickListener(v -> ToastUtil.show(this,"未编写此功能！"));
        btn_zc1.setOnClickListener(v -> ToastUtil.show(this,"未编写此功能！"));
    }
